...
const PRESETS = {
  dark: {
    ...
    '--color-success': '#3C9D6E', '--color-success-bg': 'rgba(60,157,110,0.10)',
    '--color-warning': '#D4952A', '--color-warning-bg': 'rgba(212,149,42,0.10)',
    '--color-danger': '#D94A4A', '--color-danger-bg': 'rgba(217,74,74,0.10)',
  ...
  light: {
    ...
    '--color-success': '#52C41A', '--color-success-bg': 'rgba(82,196,26,0.06)',
    '--color-warning': '#FAAD14', '--color-warning-bg': 'rgba(250,173,20,0.06)',
    '--color-danger': '#FF4D4F', '--color-danger-bg': 'rgba(255,77,79,0.06)',
