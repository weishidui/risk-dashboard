...
public interface MetricsDao {
     ...
     * 统计指定时间范围内的快照数量
     */
    @Select("SELECT COUNT(*) FROM t_metrics WHERE snapshot_time BETWEEN #{startTime} AND #{endTime}")
    int countByTimeRange(@Param("startTime") Long startTime, @Param("endTime") Long endTime);
}
