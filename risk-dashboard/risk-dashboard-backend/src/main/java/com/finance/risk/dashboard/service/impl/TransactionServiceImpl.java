...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public Long countDistinctUsers(Long startTime, Long endTime) {
        return transactionDao.countDistinctUsers(startTime, endTime);
    }

    @Override
    public Double avgClickDuration(Long startTime, Long endTime) {
        return transactionDao.avgClickDuration(startTime, endTime);
    }

    @Override
    public Long countPassByDevScore(Long startTime, Long endTime) {
        return transactionDao.countByDevScore(startTime, endTime, 80);
    }

    @Override
    public Long countBlockByDevScore(Long startTime, Long endTime) {
        return transactionDao.countByDevScore(startTime, endTime, 0)
                - transactionDao.countByDevScore(startTime, endTime, 50);
    }
